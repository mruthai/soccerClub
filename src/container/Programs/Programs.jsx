...
<div className="app__programs flex__center section__padding" id="programs">
    ...
    <div className="app__programs-content flex__center">
      ...
      <div className="app__programs-content_rec">
        ...
        <p className="p__programs-content">Lorem ipsum dolor sit, amet consectetur adipisicing elit. 
      ...
      <div className="app__programs-content_competitive">
        ...
        <p className="p__programs-content"> Lorem ipsum dolor sit amet consectetur adipisicing elit. Quas vitae quod rerum fugiat, ipsam, 
